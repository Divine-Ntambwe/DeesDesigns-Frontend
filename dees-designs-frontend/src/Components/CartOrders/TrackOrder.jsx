   ...
   <Box sx={{ minWidth: 120 }}>
    ...
    '&.Mui-focused .MuiOutlinedInput-notchedOutline': {
        ...
        >
          ...
          <MenuItem value={30}>Thirty</MenuItem>
            ...
            <div className="order">
                ...
                <Stepper connector={<LongConnector />} activeStep={3} orientation="vertical" sx={{ 
      ...
      <div className='order-details'>
        <div>
        <p><b>Order Date:</b> Tuesday, 16 February 2025</p>
        <br/>
        <p><b>Estimated Time Of Delivery:</b> Monday, 21 February 2025</p>
       <br/>
        <p>
